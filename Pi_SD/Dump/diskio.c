...
#include "pff.h"
#include "diskio.h" // conf is lower case + Fat32 + byte access
...
#include <stdio.h> // For Printf L224
#include <bcm2835.h> // Special GPIO Library for Raspberry Pi

#define SS   RPI_GPIO_P1_24 //BCM 8 for SD CS
#define SELECT()	bcm2835_gpio_write(SS,LOW) /* CS = L */
#define	DESELECT()	bcm2835_gpio_write(SS,HIGH)	/* CS = H */
...
void init_spi (void)		/* Initialize SPI port */
{
  ...
  //bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_65536); // The default
   // bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_64);   // 4 Mhz Clock
    bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_1024);   // 400 Khz Clock
